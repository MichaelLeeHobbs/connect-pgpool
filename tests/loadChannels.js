...
const loadChannels = async ()=> {
    ...
    promises.push(fetch('https://localhost:8443/api/channels', {method: 'POST', headers: {Authorization, accept: "application/json", "Content-Type": "application/xml"}, body: testInterface})
        .then(res=>res.text())
    ...
    promises.push(fetch('https://localhost:8443/api/channels', {method: 'POST', headers: {Authorization, accept: "application/json", "Content-Type": "application/xml"}, body: testRunner})
        .then(res=>res.text())
    ...
    return Promise.all(promises)
        .then(()=>{
            return fetch('https://localhost:8443/api/channels/_deploy?returnErrors=true', {method: 'POST', headers: {Authorization, accept: "application/json", "Content-Type": "application/json"}, body: deployChannels})
                .then(res=>res.text())
